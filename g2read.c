...
int main(int argc, char **argv)
{
  ...
  sprintf(basename, "tgrid2l");
  sprintf(basenameout, "snaptgrid2l");
  ...
  for(n=1;n<=Ngas;n++) { 
    ...
    if ((random*(1.e0/RAND_MAX))< 0.1e0 || P[n].FosHII > 0.5e0 || Id[n] == 4025757 || Id[n] == 3410514 || Id[n] == 4014428 || Id[n] == 4654179 || P[n].sink > 0.5) {
      fprintf(outfile,"%15.13g %8d %15.13g %15.13g %15.13g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g\n", 
	      P[n].FosHII, Id[n],x,y,z,P[n].Temp,P[n].nh,P[n].elec,P[n].H2I,P[n].HDI, P[n].gam, P[n].Vel[0],P[n].Vel[1],P[n].Vel[2],P[n].hsm, P[n].Mass);
      ncount = ncount + 1;
       }
