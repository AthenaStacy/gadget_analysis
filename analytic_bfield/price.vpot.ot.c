...
#define width_small 1.0 //which_sim==0
...
//// identify particles whose evolution shold be analytically followed
  ...
  if(which_sim == 0 || which_sim == 4 || which_sim == 5)  sprintf(input_fname, "%s/%s_%03d", path, basename2, snapshot_number);
             ...
             if(write_file == 1)
                { 
                 if(P[i].marker > 0)
                   ...
                   PAfieldy[i] = B0y / (double) tot_proc_sum;
                   PAfieldz[i] = B0z / (double) tot_proc_sum;
                   }
                 }
               ...
               for(n=nmin; n<=nmax; n++)
                      ...
                      if(P[i].Id == plist_id[n])
                         ...
                         if(j == 0)
                           ...
                           plist1[n].A_anal[1] =  B0y;
                           plist1[n].A_anal[2] =  B0z;
                           }
                          if(j == 0 && restart == 1)
                           {
