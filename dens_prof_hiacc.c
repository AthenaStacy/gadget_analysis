...
int main(int argc, char **argv)
{
  ...
  double m_enc_arr[arrnum], m_enc_nosink[arrnum], d_arr[arrnum], mass_enc, n_arr[arrnum], n_arr2[arrnum], surf_dens_arr[arrnum]; 
  ...
  for(j=jnum;j<=4100;j=j+100)
  //for(j=500;j<=500;j=j+100)
  ...
  nthresh = 1.e4;	  	
	...
	for(n=0; n<arrnum; n++)
          {
          m_enc_arr[n] = m_enc_nosink[n] = amom_arr[n] = n_arr[n] = n_arr2[n] = surf_dens_arr[n] = c_s_arr[n] = 0.0;
         ...
         for(i = 0; i < Ngas; i++)
		   ...
		   ncount++;  
             ...
             for(n=0; n<arrnum; n++)
                   ...
                   fprintf(outfile2, "%15.11g %15.11g %15.11g %15.11g %15.11g %15.11g %15.11g %15.11g %15.11g %15.11g %15.11g\n", d_arr[n], m_enc_arr[n], m_enc_nosink[n], dens_arr[n], surf_dens_arr[n], c_s_arr[n], temp_arr[n], mbe_arr[n], omega_arr[n], vrad_arr[n], vrot_arr[n]);
