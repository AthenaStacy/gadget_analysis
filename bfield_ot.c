...
int main(int argc, char **argv)
  {
    ...
    int N_begin = 44;  //which_sim == 4
    int N_end = 44;

    //int N_begin = 10;  //which_sim == 6
    //int N_end = 100;
...
//    int n_grid2[N_grid][N_grid];
    ...
    if(which_sim == 0) 
      {
      sprintf(dir, "/scratch/00863/minerva/otS");
      sprintf(dir_out, "/scratch/00863/minerva/otS");
      }
    if(which_sim == 1)
      {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////// 
        ...
        Bmean = Btot / ntot;
        Brms = pow(Bmean, 0.5);
        printf("Brms = %lg Bmin = %lg, Bmax = %lg, center_z = %lg\n", Brms, Bmin, Bmax, center_z);
