...
#define width_small 2.e-3  //full width in pc of cubic box of particles whose evolution will be tracked
            ...
            for(n=nmin; n<=nmax; n++)
                ...
                for(p=0; p<3; p++)
                 ...
                 if(plist0[n].nh_anal <= 0 || plist0[n].nh_anal != plist0[n].nh_anal)
                   ...
                   plist0[n].B_anal[0] = 0;
                   plist0[n].B_anal[1] = 0;
                   plist0[n].B_anal[2] = B0 * pow(plist0[n].dens/rho_baryon, 2./3.);
                ...
                for(p=0; p<3; p++)
                 ...
                 if(n < 5) 
                 printf("n = %d, n_neighb = %d, dens0 = %lg, nh_anal0 = %lg, dens1 = %lg, nh_anal1 = %lg, dens_alt1 = %lg, hsm0 = %lg, hsm1 = %lg, deform = %lg, detD = %lg, detD_anal = %lg, B_phys = %lg. B_anal[0] = %lg, B_anal[1] = %lg, B_anal[2] = %lg\n",
                    ...
                    plist0[n].dens/plist1[n].dens, plist1[n].detD, plist0[n].B_anal[0] * pow(plist1[n].dens/plist0[n].dens, 2./3.), plist1[n].B_anal[0], plist1[n].B_anal[1], plist1[n].B_anal[2]);
