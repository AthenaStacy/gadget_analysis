...
int main(int argc, char **argv)
{
  ...
  sprintf(basenameout, "snaphires_am2_pos");
  ...
  for(n=1;n<=Ngas;n++) { 
    ...
    dum_num = 5.0;
      ...
      fprintf(outfile,"%15.13g %8d %15.13g %15.13g %15.13g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g\n", dum_num, P[n].Id,P[n].Pos[0],P[n].Pos[1],P[n].Pos[2],dum_num,P[n].nh,dum_num,dum_num,dum_num, dum_num, disAU, vrad, vrot,dum_num, P[n].Mass);
      ncount = ncount + 1;
       }
