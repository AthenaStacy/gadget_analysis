...
int write_snapshot(char *fname, int files, char *outname, double delx, double dely, double delz, double  boxsize)
{
  ...
  double ngrid_xleft=1, ngrid_yleft=1, ngrid_zleft=1, ngrid_x=256, ngrid_y=256, ngrid_z=11;
  double ngrid_tot = 0;
...
//////////write new file!!!!!!!!!!!
      ...
      for(k=0,pc_new=pc;k<6;k++)
	{
     ...
     rho_init = 25. / (36. * PI);
     volume = header1.BoxSize * header1.BoxSize * header1.BoxSize * (ngrid_z / ngrid_x);
