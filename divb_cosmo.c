...
int main(int argc, char **argv)
  {
    ...
    int N_dm = 0;
    int N_grid = 200;
    //int N_begin = 160;   //which_sim == 4
    //int N_end = 160;
    //int N_begin = 140;
    //int N_end = 140;
    //int N_begin = 434;  //which_sim == 6
    //int N_end = 444;
    int N_begin = 275;  //which_sim == 7
    int N_end = 275;
...
//    int n_grid2[N_grid][N_grid];
    ...
    double min = 1.e-24;    //bfield range  
    double max = 1.e-15;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////// 
        ...
        for(n=0;n<Ngas;n++)
          ...
          //if(do_error == 1) P[n].DivB = (P[n].Bmag/1.e-20) / pow((P[n].nh/1.e-1), 0.7);
          }            
...
if(x2 <= 1.0)
  {
    ...
    else grid1[i][j] += weight * P[n].DivB * W_x;
