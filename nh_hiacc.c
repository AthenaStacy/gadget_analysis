...
//    int n_grid2[N_grid][N_grid];
    ...
    double entries = 0.0;
    double temp_pos = 0.0;
    //double min = 1.e-20;     //hires density range  
    //double max = 1.e-12;
    double min = 1.e8;     //hires density range  
    double max = 1.e14;
    double abs_min = min;
    double abs_max = max;
    ...
    for(m = N_begin; m < N_end+1; m=m+10)
      {
        ...
        //width= 2000.*4.85e-6*header.HubbleParam/(1.e3*header.time);  //cut out central 2000 AU
