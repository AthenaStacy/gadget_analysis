...
int main(int argc, char **argv)
 ...
 //   int n_grid1[N_grid][N_grid];
    ...
    //double center_x = 50.339001738;
    //double center_y = 50.117793466;
    //double center_z = 49.487139457;
    ...
    //sprintf(dir, "/work/00863/minerva/tgrid_ifront_lowrho3b");
    //sprintf(dir, "/work/00863/minerva/tgridsink10_g2shift");
    //sprintf(dir, "/work/00863/minerva/tgridsink_ifront_nf5b");
    sprintf(dir, "/work/00863/minerva/ds_nr/ds_nr6e");
	...
	printf("Point 1\n");
        ...
        width= 50.*4.85e-2*header.HubbleParam/(1.e3*header.time);
        slice= 50.*4.85e-2*header.HubbleParam/(1.e3*header.time);
...
x2 = ((P[n].Pos[0] - center_i) * (P[n].Pos[0] - center_i) + (P[n].Pos[1] -
