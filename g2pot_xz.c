...
//    int n_grid2[N_grid][N_grid];
        ...
        if(m < 10)
          {
            ...
            sprintf(buf, "%s_00%d.potxz", dir, m);
	...
	center_z=zCOM/ncount_doub;
        ...
        for(n = 0; n < N_gas; n++)
          {
          if(P[n].pot < pot_min && double(fabs(P[n].Pos[0]-center_x)) < width/2.0 && double(fabs(P[n].Pos[2]-center_z)) < width/2.0 && double(fabs(P[n].Pos[1]-center_y)) < width/2.0 && double(fabs(P[n].Pos[1]-center_y)) < slice/2.0)
            {
            pot_min = P[n].pot;
            }
          if(P[n].pot > pot_max && double(fabs(P[n].Pos[0]-center_x)) < width/2.0 && double(fabs(P[n].Pos[2]-center_z)) < width/2.0 && double(fabs(P[n].Pos[1]-center_y)) < width/2.0 && double(fabs(P[n].Pos[1]-center_y)) < slice/2.0)
            {
            pot_max = P[n].pot;
            }
          } 
...
printf("abs_min = %lg, abs_max = %lg\n", abs_min, abs_max);
        ...
        for(n = 0; n < N_gas; n++)
          {
            if(P[n].sink > -1 && double(fabs(P[n].Pos[0]-center_x)) < width/2.0 && double(fabs(P[n].Pos[2]-center_z)) < width/2.0 && double(fabs(P[n].Pos[1]-center_y)) < width/2.0 && double(fabs(P[n].Pos[1]-center_y)) < slice/2.0)
              {
