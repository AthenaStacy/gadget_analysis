...
int main(int argc, char **argv)
 ...
 //   int n_grid1[N_grid][N_grid];
    ...
    //sprintf(dir, "/scratch/00863/minerva/tgridsink_ifront_nr6e");
	...
	printf("Point 1\n");
        ...
        width= 4*4.85e-2*header.HubbleParam/(1.e3*header.time);
        slice= 4*4.85e-2*header.HubbleParam/(1.e3*header.time);
