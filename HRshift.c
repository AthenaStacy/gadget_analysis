//Recenters simulation box so highest-density peak will be at center of the box
...
int main(int argc, char **argv)
{
  ...
  sprintf(path, "/work/utexas/ao/minerva/ICs");
  sprintf(basename, "ic_tgridls");
  ...
  sprintf(output_fname, "/work/utexas/ao/minerva/ICs/icshift_tgridls_000");
	  ...
	  for(n=0;n<header1.npart[k];n++)
	    {
  	      ...
  	      fread(&P[pc_new].Pos[0], sizeof(float), 3, fd);
             ...
             if(z > 100.0){
              ...
              pos[0]=P[pc_new].Pos[0];
              pos[1]=P[pc_new].Pos[1];
              pos[2]=P[pc_new].Pos[2];
