...
int main(int argc, char **argv)
{
  ...
  //sprintf(basename, "midhires_seed_shift");
  //sprintf(basename, "bin_seed");
  sprintf(basename, "bin_seed_shift_zoom10");
  snapshot_number= 0;                   /* number of snapshot */
  files=1;     

  sprintf(input_fname, "%s/%s_%03d", path, basename, snapshot_number);
  //sprintf(output_fname, "/nobackupp1/astacy/midhires_000");
  //sprintf(output_fname, "/nobackupp1/astacy/bin_000");
  sprintf(output_fname, "/nobackupp1/astacy/bin_zoom10_000");
...
#define WSKIP fwrite(&dummy, sizeof(dummy),1, outfile);
  ...
  for(i=0, pc=1; i<files; i++, pc=pc_new)
      ...
      for(k=0,pc_new=pc;k<6;k++)
	{
      ...
      printf("x = %lg, %lgy =, z =%lg \n", P[1000].Pos[0], P[1000].Pos[1], P[1000].Pos[2]);
      printf("Ngas= %6d \n",Ngas); 
//      printf("N_DM= %6d \n",NumPart-Ngas); 
