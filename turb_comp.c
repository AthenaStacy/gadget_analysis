  ...
  printf("hi 5\n");
         ...
         for(n = 0; n < Ngas; n++)
            ...
            if(P[n].to_print > 0)
              ...
              P[n].soundspeed, P[n].Id,x,y,z,P[n].Temp,P[n].nh,P[n].HII,P[n].H2I,P[n].HDI, P[n].gam, disAU, vrad, vrot, P[n].hsm*Time/0.7, P[n].Mass, P[n].Vel[0]*pow(Time, 0.5), P[n].Vel[1]*pow(Time, 0.5), P[n].Vel[2]*pow(Time, 0.5), P[n].turb);
              ncount = ncount + 1;
              } 
            }
   printf("ncount = %d.\n", ncount);
