...
#if(readB)
  double nh_test, Bfieldx, Bfieldy, Bfieldz, Bmag;
...
int main(int argc, char **argv)
  {
    ...
    //int N_begin = 200;
    //int N_end = 200;
    //int N_begin = 90;   //which_sim==4
    //int N_end = 90;
    //int N_begin = 140;
    //int N_end = 140;
    //int N_begin = 435;  //which_sim == 6
    //int N_end = 435;
    int N_begin = 279;
    int N_end = 279;
...
//    int n_grid2[N_grid][N_grid];
    ...
    //double min = 1.e-26;   //density range
    //double max = 1.e-23;
    double min = 1.e-25;   //density range
    double max = 1.e-20;   //density range
    //double min = 1.e-24;     //density range  
    //double max = 1.e-19;
    //double min = 1.e-25;
    //double max = 1.e-15;
    //double min = 1.e-22;
    ...
    if(which_sim == 3)
      sprintf(dir, "/work/00863/minerva/bin_zoom/bin_zoom10_new_cut_ref3");
    if(which_sim == 4) 
    ...
    if(which_sim == 7)
      ...
      //sprintf(dir, "/scratch/00863/minerva/bin_zoom10_ref4_newtstepS");
...
*/
         ...
         center_y=ymax;
         center_z=zmax;
         printf("center_x = %lg, center_y = %lg, center_z = %lg\n", center_x, center_y, center_z);
