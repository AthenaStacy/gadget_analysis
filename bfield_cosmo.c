...
int main(int argc, char **argv)
  {
    ...
    int N_dm = 0;
    int N_grid = 200;
    //int N_begin = 5979;  //which_sim==0
    //int N_end = 5979;
    //int N_begin = 140;  //which_sim==5  
    //int N_end = 140;
    //int N_begin = 260;   //which_sim==4
    //int N_end = 260;
    //int N_begin = 434;  //which_sim == 6
    //int N_end = 444;
    int N_begin = 304;  //which_sim == 7
    int N_end = 304;
...
//    int n_grid2[N_grid][N_grid];
    ...
    //double min = 1.e-21;
    //double max = 1.e-17;
    //double min = 1.e-20;    //bfield range  
    //double max = 1.e-12;
    double min = 1.e-20;   //10pc size
    double max = 1.e-16;
    //double min = 1.e-14;  //1pc size       
    //double max = 1.e-9;
    //double min = 1.e-18;   
    //double max = 1.e-12;
    ...
    if(which_sim == 3)
      sprintf(dir, "/scratch/00863/minerva/bin_zoom1_ref3_newtstep");
    if(which_sim == 4) 
      sprintf(dir, "/scratch/00863/minerva/bin_zoom10_ref3_newtstep");
      //sprintf(dir, "/scratch/00863/minerva/bin_zoom10_ref3_divclean");
    if(which_sim == 5)
      sprintf(dir, "/scratch/00863/minerva/bin_zoom10_ref2");
      //sprintf(dir, "/scratch/00863/minerva/bin_zoom10_ref2_divclean");
      //sprintf(dir, "/scratch/00863/minerva/bin_zoom10_ref2_divsmooth");
    if(which_sim == 6)
      sprintf(dir, "/scratch/00863/minerva/bin_zoom1_ref4_newtstep");
      //sprintf(dir, "/scratch/00863/minerva/bin_zoom1_ref4_endsmooth");
    if(which_sim == 7)
      sprintf(dir, "/scratch/00863/minerva/bin_zoom10_ref4_corr4");
      //sprintf(dir, "/scratch/00863/minerva/bin_zoom10_ref4_divsmooth");
      //sprintf(dir, "/scratch/00863/minerva/bin_zoom10_ref4_divsmooth2");
      //sprintf(dir, "/scratch/00863/minerva/bin_zoom10_ref4_newtstep");
      //sprintf(dir, "/scratch/00863/minerva/bin_zoom10_ref4_endsmooth");
...
#endif 
//////////////////////////////////////////////////////////////////////////////////
        //double width_pc = 100.0;
        double width_pc = 50.0;
        //double width_pc = 10.0; 
        //double width_pc = 1.0; 
        ...
        width =  width_pc*header.HubbleParam/(1.e3*header.time);
...
*/
  ...
  //       center_x = 107.1276445; center_y = 101.2022308, center_z = 109.3879302;

         printf("nhmax = %lg, center_x = %15.11g, center_y = %15.11g, center_z = %15.11g\n", nhmax, center_x, center_y, center_z);
...
// convert vector potential to b-field
  ...
  double disx, disy, disz;
  double nh_min = 1.e50;
  double hsm_min = 100., hsm_max = -100.;
  for(n=0;n<Ngas;n++)
     {
     ...
     if(fabs(disx) < width_pc && fabs(disy) < width_pc && fabs(disz) < width_pc)
       ...
       if(P[n].Hsml < hsm_min) hsm_min = P[n].Hsml;
       if(P[n].Hsml > hsm_max) hsm_max = P[n].Hsml;
       }
     }

    hsm_min = hsm_min * 1.e3 * Time / hubble_param;
    hsm_max = hsm_max * 1.e3 * Time / hubble_param;
    printf("final idnum = %d, Ngas = %d, nh_min = %lg\n", idnum, Ngas, nh_min);
    printf("hsm_min = %lg, hsm_max = %lg\n", hsm_min, hsm_max);
  ...
  for(n=0;n<Ngas;n++)
    ...
    P[n].Hsml = P[n].Hsml*cosmo_fac*hfac_out;
    }
