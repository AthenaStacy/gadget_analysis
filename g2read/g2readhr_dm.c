...
int main(int argc, char **argv)
{
  ...
  sprintf(basename, "bf2");
  sprintf(basenameout, "snapbf2_small");
  ...
  for(n=1;n<=Ngas;n++) { 
    ...
    random = rand();
         ...
         //for(n = Ngas+1; n <= NumPart; n++)
           for(n = 1; n <= Ngas; n++)
             {
              fprintf(outfile,"%8d %15.13g %15.13g %15.13g %15.6g %15.6g %15.6g %15.6g \n", P[n].Id, P[n].Pos[0], P[n].Pos[1], P[n].Pos[2], P[n].Vel[0], P[n].Vel[1], P[n].Vel[2], P[n].Mass);
             }
