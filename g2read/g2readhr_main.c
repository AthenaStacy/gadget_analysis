...
int main(int argc, char **argv)
{
  ...
  sprintf(basenameout, "snaphires_am2");
  ...
  for(n=1;n<=Ngas;n++) { 
    ...
    random = rand();
    dum_num = 5.0;
//Take highest-density point instead of sink point
         sinkposx=xmax;
         sinkposy=ymax;
         sinkposz=zmax; 
         ...
         for(n = 1; n <= Ngas; n++)
             ...
             P[n].Vel[0] = P[n].Vel[0] - velx;
             P[n].Vel[1] = P[n].Vel[1] - vely;
             P[n].Vel[2] = P[n].Vel[2] - velz;
...
;  //convert to km/s
    ...
    if (/*(random*(1.e0/RAND_MAX))< 0.1e0*/  P[n].nh > 5.e0 || P[n].Id % 1000 == 0) {
      ...
      fprintf(outfile,"%15.13g %8d %15.13g %15.13g %15.13g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g\n", dum_num, P[n].Id,P[n].Pos[0],P[n].Pos[1],P[n].Pos[2],P[n].Temp,P[n].nh, dum_num, dum_num, dum_num, dum_num, disAU, vrad, vrot, P[n].hsm, P[n].Mass);
      ncount = ncount + 1;
       }
