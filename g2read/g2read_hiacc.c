...
;  //convert to km/s
             ...
             if(P[n].nh > 1.e12 && P[n].sink > -4 && n%1 == 0)
               printf("ID = %d, nh = %lg, temp = %lg, elec %lg, H2 = %lg HeII = %lg mass = %lg, hsm = %lg\n", P[n].Id, P[n].nh, P[n].Temp, P[n].HII, P[n].H2I, P[n].HeII, P[n].Mass, P[n].hsm*1.e3*Time/(0.7)*206264.806);
    ...
    if(P[n].nh > 1.e3 && random*(1.e0/RAND_MAX)< 0.25e0 /*|| P[n].sink > 0.5 || (random*(1.e0/RAND_MAX))< 0.02e0*/) 
    //if(dis < 1.e1)
      {
