...
{
  char path[200], pathout[200], input_fname[200], output_fname[200], basename[200], basenameout[200];
  ...
  double sinkposx, sinkposy, sinkposz, disAU, dis_pc, hsm_pc, vrad, vrotx, vroty, vrotz, vrot, mh_mass;
  ...
  sprintf(basenameout, "snapvort");

  //sprintf(basename, "vortR");
  //sprintf(basenameout, "snapvortR");
  ...
  for(n=0;n<Ngas;n++) { 
         ...
         //for(n = 0; n < Ngas; n++)
             ...
             if(dis > dismax)
                dismax = dis;
             dis_pc = dis*1.e3*Time/hubble_param;
    ...
    if((random*(1.e0/RAND_MAX)< 0.2 /*&& P[n].nh > 3.e-2*/) /*|| P[n].nh > 2.e1*/ /*&& P[n].sink < 0*/ /* ||  P[n].sink > 0.5*/ || P[n].Id < 3 ) 
      ...
      //fprintf(outfile,"%15.13g %12d %15.13g %15.13g %15.13g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g\n", P[n].sink, P[n].Id,x,y,z,P[n].Temp,P[n].nh,P[n].HII,P[n].H2I,P[n].HDI, P[n].gam, disAU, P[n].Vel[0], P[n].Vel[1],P[n].Vel[2], P[n].Mass);
       ...
       fprintf(outfile,"%15.13g %12d %15.13g %15.13g %15.13g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g\n",
        P[n].dummy, P[n].Id,x,y,z,P[n].Temp,P[n].nh,vx,vy,vz, P[n].dummy, dis, vrad, vrot, hsm_pc, P[n].Mass, P[n].Bfieldx, P[n].Bfieldy, P[n].Bfieldz, P[n].DivB);
