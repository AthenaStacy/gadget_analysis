//Reads in DM profile output from "create_ic.pro."  
//Converts the DM values from float to double, and writes those to output file.
//Also reads in a gas-only file and writes to the same output file.
