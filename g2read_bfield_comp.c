...
//#define width_small 0.02  //Orion2 box distance in pc
...
//#define snapbegin 340 //which_sim == 6

#define snapend 7055
//#define snapend 5980  //(which_sim==0)
//#define snapend 7132 //which_sim == 3
//#define snapend 680 //which_sim == 4
//#define snapend 283 //which_sim == 5
//#define snapend 340  //which_sim == 6
...
//#endif
  ...
  //double gam, sink;
  double gam, HII, DII, HDI, HeII, HeIII;
  double H2I;
  double dummy;
...
int main(int argc, char **argv)
{
  ...
  if(which_sim == 3)
   ...
   //sprintf(path2, "/work/00863/minerva/orion/bin_zoom/mid_tstep_alt_smallbox");
   //sprintf(path2, "/work/00863/minerva/orion");
   sprintf(path2, "/work/00863/minerva/orion/bin_zoom");
...
///////////////////////////////get ID of particles whose evolution was followed////////////////
  ...
  for(i = 0; i < Ngas; i++)
   ...
   int iskip, iskip_outer;
   if(which_sim == 3) {iskip = 1; iskip_outer = 1;}
   if(which_sim == 0) {iskip = 1; iskip_outer = 1;}
   if(which_sim == 6) {iskip = 100; iskip_outer = 100;}
  ...
  for(i = 0; i < Ngas; i++)
     ...
     if(disx < width_small/2.0 && disy < width_small/2.0 && disz < width_small/2.0 && i%iskip == 0)
        idnum++;
     if(disx < width_outer/2.0 && disy < width_outer/2.0 && disz < width_outer/2.0 && i%iskip_outer == 0)
        idnum_outer++;
     }
...
//#endif
  ...
  hsm_max = hsm_max * 1.e3; //convert from kpc to pc
  nmin = 0.5*nmin; 
...
;  //convert to km/s
    ...
    //if(random*(1.e0/RAND_MAX)< 0.001e0) to_print++;
    if(random*(1.e0/RAND_MAX)< 0.2e0) to_print++;
    //if(fabs(P[n].Bfieldx) > bmin || fabs(P[n].Bfieldy) > bmin || fabs(P[n].Bfieldz) > bmin) to_print++;
    //if(dis < 1.0) to_print = 1;    
    ...
    if(to_print > 0)
      ...
      if(vpot == 0)
        ...
        P[n].dummy, P[n].Id,x,y,z,P[n].Temp,P[n].nh,P[n].HII,P[n].H2I,P[n].HDI, P[n].gam, disAU, vrad, vrot, hsm_pc, P[n].Mass, P[n].Bfieldx, P[n].Bfieldy, P[n].Bfieldz, P[n].nh_test);
        //printf("hi line 893\n");
        }
      if(vpot == 1)
        {
        fprintf(outfile,"%15.13g %12d %15.13g %15.13g %15.13g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g\n",
        P[n].error, P[n].Id,x,y,z,P[n].Temp,P[n].nh,P[n].Afield[0],P[n].Afield[1],P[n].Afield[2], P[n].gam, disAU, vrad, vrot, P[n].hsm_pc, P[n].Mass, P[n].Bfieldx, P[n].Bfieldy, P[n].Bfieldz, P[n].nh_test);
        //printf("hi line 899\n");
        }

#else

       //printf("hello line 904\n");

       fprintf(outfile,"%15.13g %12d %15.13g %15.13g %15.13g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g\n",
        P[n].dummy, P[n].Id,x,y,z,P[n].Temp,P[n].nh,P[n].dummy,P[n].dummy,P[n].dummy, P[n].dummy, disAU, vrad, vrot, hsm_pc, P[n].Mass, P[n].Bfieldx, P[n].Bfieldy, P[n].Bfieldz, P[n].dummy);
