...
int main(int argc, char **argv)
{
  ...
  int  i, k=0, j, n, type, snapshot_number, files, Ngas, random, ncount, ncounthalo1, arrnum=300;
  ...
  double dis12, dis13, vx_com, vy_com, vz_com, vx1, vy1, vz1, vx2, vy2, vz2, vx3, vy3, vz3, vx4, vy4, vz4;
  ...
  double m_enc_arr[arrnum], d_arr[arrnum], mass_enc, n_arr[arrnum], surf_dens_arr[arrnum], dens_arr[arrnum];
