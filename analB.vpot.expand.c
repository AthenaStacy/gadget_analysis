...
int main(int argc, char **argv)
{
  ...
  double hfac = 1.0, hfac_in = 0.0, neighb_typ = 80., ngb_count; 
  double time_fac, time_fac0, cosmo_fac, cosmo_fac0, init_pow=2./3.;
...
///////////////////////////////////////////////////////////
            ...
            for(n=nmin; n<=nmax; n++)
                ...
                for(p=0; p<3; p++)
                 ...
                 if(n < 5) printf("fcor0 = %lg, dcor = %lg, dwdu0[0] = %lg, dwdu0[1] = %lg, dwdu0[2] = %lg\n", fcor0, dcor, nb[n-nmin].dwdu0[0][5], nb[n-nmin].dwdu0[1][5], nb[n-nmin].dwdu0[2][5]);
                 ...
                 printf("j = %d, n = %d, n_neighb0 = %d, n_neighb1 = %d, dens0 = %lg, dens1 = %lg, dAdt[0] = %lg, dAdt[1] = %lg, dAdt[2] = %lg, fcor1 = %lg, A_anal0[0] = %lg, A_anal0[1] = %lg, A_anal0[2] = %lg hsm0 = %13.10g, hsm1 = %13.10g, vel_fac = %lg, dis_fac = %lg, dWdu0 = %lg, A_exp = %lg, kernel = %lg,  A_anal[0] = %lg, A_anal[1] = %lg, ERROR = %lg\n",
