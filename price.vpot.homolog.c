...
#define width_small 3e1  //for homog; full width in pc of cubic box of particles whose evolution will be tracked
...
double hsm_calibrate(int n, int nmin, double nu, double hfac, int mode);
        ...
        if(j > 0)
         {
		  ...
		  for(q=0; q<3; q++) 
                 ...
                 plist1[n].A_anal[0] = (plist0[n].A_anal[0] * jacob_fin[0][0] + plist0[n].A_anal[1] * jacob_fin[0][1] + plist0[n].A_anal[2] * jacob_fin[0][2]);
                 plist1[n].A_anal[1] = (plist0[n].A_anal[1] * jacob_fin[1][1] + plist0[n].A_anal[0] * jacob_fin[1][0] + plist0[n].A_anal[2] * jacob_fin[1][2]);
                 plist1[n].A_anal[2] = (plist0[n].A_anal[2] * jacob_fin[2][2] + plist0[n].A_anal[0] * jacob_fin[2][0] + plist0[n].A_anal[1] * jacob_fin[2][1]);
                 ...
                 printf("n = %d, n_neighb0 = %d, n_neighb1 = %d, dens0 = %lg, dens1 = %lg, jfin[0] = %lg, jfin[1] = %lg, jfin[2] = %lg, fcor1 = %lg, A_anal0[0] = %lg, A_anal0[1] = %lg, A_anal0[2] = %lg hsm0 = %lg, hsm1 = %lg, det_jacob = %lg, dis_fac = %lg, dWdu0 = %lg, A_exp = %lg, kernel = %lg,  A_anal[0] = %lg, A_anal[1] = %lg, ERROR = %lg\n",
                    n, plist1[n].NumNeighb, plist1[n].NumCalc, plist0[n].dens, plist1[n].dens, jacob_fin[0][0], jacob_fin[1][1], jacob_fin[2][2], fcor1, 
                    plist0[n].A_anal[0], plist0[n].A_anal[1], plist0[n].A_anal[2], plist0[n].hsm, plist1[n].hsm,
                    det_jacob, dis_fac, dWdu0, A_exp,  nb[n-nmin].kernel0[k-1], 
                    plist1[n].A_anal[0],  plist1[n].A_anal[1],  (A_exp - plist1[n].A_anal[0]) / A_exp );
                 printf("ERROR_DENS = %lg\n", (dens_exp - plist1[n].dens) / dens_exp);
                 printf("jinv00 = %lg, jinv01 = %lg, jinv02 = %lg, jinv10 = %lg, jinv11 = %lg, jin12 = %lg, jinv20 = %lg, jinv21 = %lg, jinv22 = %lg\n", jacob_inv[0][0], jacob_inv[0][1], jacob_inv[0][2], jacob_inv[1][0], jacob_inv[1][1], jacob_inv[1][2], jacob_inv[2][0], jacob_inv[2][1], jacob_inv[2][2]);
                 }
