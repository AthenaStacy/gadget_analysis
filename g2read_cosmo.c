...
//#define snapbegin 138 //which_sim == 5
#define snapbegin 304 //which_sim == 6
...
;  //convert to km/s
    ...
    if(random*(1.e0/RAND_MAX)< 0.01) to_print++;
    ...
    int id_list[10] = {3551928,       11616832,       11237167,       10120649,       11140786,       11522899,       11622634,       10973400,      11985576,       11921814};


    if(P[n].Id == id_list[0] || P[n].Id == id_list[1] || P[n].Id == id_list[2] || P[n].Id == id_list[3] || P[n].Id == id_list[4] || P[n].Id == id_list[5] || P[n].Id == id_list[6] || P[n].Id == id_list[7] || P[n].Id == id_list[8] || P[n].Id == id_list[9])
     to_print++;
    ...
    if(to_print > 0)
      ...
      if(vpot == 0)
        ...
        P[n].error, P[n].Id,x,y,z,P[n].Temp,P[n].nh,P[n].HII,P[n].H2I,P[n].HDI, P[n].gam, disAU, vrad, vrot, hsm_pc, P[n].Mass, P[n].Bfieldx, P[n].Bfieldy, P[n].Bfieldz, P[n].nh_test);
      if(vpot == 1)
        fprintf(outfile,"%15.13g %12d %15.13g %15.13g %15.13g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g\n",
       ...
       fprintf(outfile,"%15.13g %12d %15.13g %15.13g %15.13g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g %15.6g\n",
        P[n].dummy, P[n].Id,x,y,z,P[n].Temp,P[n].nh, P[n].dummy, P[n].H2I, vz, P[n].dummy, disAU, vrad, vrot, hsm_pc, P[n].Mass, P[n].Bfieldx, P[n].Bfieldy, P[n].Bfieldz, P[n].DivB);
