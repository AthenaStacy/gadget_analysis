...
xyouts,0.03,0.04,'Length: 50 pc (physical)', charsize=csize, /normal
;xyouts,0.03,0.04,'Length: 10 pc (physical)', charsize=csize, /normal
;xyouts,0.03,0.04,'Length: 1 pc (physical)', charsize=csize, /normal
;xyouts,0.03,0.04,'Length: 0.5 pc (physical)', charsize=csize, /normal

xyouts,0.70,0.84,'log n!DH!N',charsize=csize, /normal
xyouts,0.70,0.76,'[cm!U-3!N]',charsize=csize, /normal
