pro create_ic, file, outfile, npart0, MC=MC, ICs = ICs, debug = debug, setup = setup, coremc = coremc, rescaleonly = rescaleonly, nocore= nocore, rin = rin
...
; ==========================================================================
 ...
 case 1 of
     ...
     (setup eq 'test6'): begin

;; Test 6 (Iliev et al. 2010)
;; ==========================================================================
...
;; method parameters
         ...
         gadget_pos *= gadget_boxsize / box
         expscale = 2 ;; scaling to produce 1/r^2 power law
         expfit = -3.0 ;; empirical exponent to smoothly join the densities at r0, depends on gadget_boxsize 
     end
...
;; method parameters
         ...
         gadget_pos *= gadget_boxsize / box
         expscale = 2 ;; scaling to produce 1/r^2 power law
         expfit = -10.8 ;; empirical exponent to smoothly join the densities at r0, depends on gadget_boxsize 
     end


     (setup eq 'minihalo4'): begin
...
;; method parameters
         ...
         gadget_pos *= gadget_boxsize / box
         expscale = 2 ;; scaling to produce 1/r^2 power law
         expfit = -6.8 ;; empirical exponent to smoothly join the densities at r0, depends on gadget_boxsize 
     end
    ...
    for i = 0, 2 do begin
        ...
        new_pos[i,*] = StarPos[i] + $ ; stretching center
          ((new_pos[i,*] - StarPos[i]) * scale ); $ ; stretching
           ;/(gadget_boxsize / 2.)^expfit) ; re-scaling 
...
plot, alog10(rc), alog10(rhoav), psym = 1, lines = 0, color = fsc_color('black'), $
  xtitle = TexToIdl('log_{10} r [pc]'), ytitle = TexToIdl('log_{10} n_H [cm^{-3}]'), $ 
...
if not keyword_set(nocore) then begin
    ...
    if count gt 0 then $
      oplot, alog10(rc[good]), alog10(n0 / (rc[good] / r0)^2), psym = 0, lines = 0, color = fsc_color('black')
    
    good = where(rc le r0)
    if count gt 0 then $
      oplot, alog10(rc[good]), alog10(n0 * rc[good]/rc[good]), psym = 0, lines = 0, color = fsc_color('black')
...
;; box size
oplot, alog10([boxhalf, boxhalf]), [-10,10], lines = 2, color = fsc_color('black')

;;; core radius
oplot, alog10([r0, r0]), [-10,10], lines = 2, color = fsc_color('black')

;; output profile
oplot, alog10(rc), alog10(rhoav), psym = 10, lines = 0, color = fsc_color('red')
...
if keyword_set(debug) then begin
    ...
    plot, xplot, yplot, $
      psym=3, /iso, xrange=xrange, yrange=yrange, /xs, /ys, xtitle='pc', ytitle='pc', $
      position = position, color = fsc_color('black')
...
npart0 = 310
create_ic, "icsL013.2N128-Glass032-Stroemgren", "minihalo-r01e-3n03e3-Ms001-glass", npart0, setup = 'minihalo0', /ICs, /debug, /nocore

stop

stop
npart0 = 70
create_ic, "icsL013.2N128-Glass032-Stroemgren", "minihalo-r01e-3n03e3-Ms005-glass", npart0, setup = 'minihalo0', /ICs;, /debug

stop
npart0 = 14
create_ic, "icsL013.2N128-Glass032-Stroemgren", "minihalo-r01e-3n03e3-Ms025-glass", npart0, setup = 'minihalo0', /ICs;, /debug


stop
npart0 = 7
create_ic, "icsL013.2N128-Glass032-Stroemgren", "minihalo-r01e-3n03e3-Ms050-glass", npart0, setup = 'minihalo0', /ICs;, /debug
npart0 = 3
create_ic, "icsL013.2N128-Glass032-Stroemgren", "minihalo-r01e-3n03e3-Ms100-glass", npart0, setup = 'minihalo0', /ICs;, /debug
...
create_ic, "icsL013.2N128-Glass032-Stroemgren", "yoshida-N064", 360., setup = 'yoshida', /ICs, /nocore, rin = 1e-4;, /coremc

stop
create_ic, "icsL013.2N128-Glass032-Stroemgren", "yoshida-N032", 45., setup = 'yoshida', /ICs, /nocore, rin = 1e-4, /debug;, /coremc

stop

create_ic, "icsL013.2N128-Glass032-Stroemgren", "yoshida-N048", 151., setup = 'yoshida', /ICs, /nocore, rin = 1e-4 ;, /coremc
...
create_ic, "icsL013.2N128-Glass032-Stroemgren", "minihalo-r03e-3n03e3-Ms025-glass-nocore", 1000., setup = 'minihalo1', /ICs, /nocore, /debug, rin = 1e-4;, /coremc
...
create_ic, "icsL013.2N128-Glass032-Stroemgren", "minihalo-r03e-3n03e3-Ms050-glass-nocore", 500., setup = 'minihalo1', /ICs, /nocore;, /debug;, /coremc
create_ic, "icsL013.2N128-Glass032-Stroemgren", "minihalo-r03e-3n03e3-Ms100-glass-nocore", 250., setup = 'minihalo1', /ICs, /nocore;, /debug;, /coremc

stop

npart0 = 50
create_ic, "icsL013.2N128-Glass032-Stroemgren", "minihalo-r03e-3ne4-Ms025-glass", npart0, setup = 'minihalo4', /ICs ;, /debug
...
; npart0 = 335
; create_ic, "icsL013.2N128-Glass032-Stroemgren", "minihalo-r03e-3n03e3-Ms025-glass", npart0, setup = 'minihalo1', /ICs;, /debug
; stop
; npart0 = 2677
; create_ic, "icsL013.2N128-Glass032-Stroemgren", "minihalo-r06e-3n03e3-Ms025-glass", npart0, setup = 'minihalo2', /ICs;, /debug
; npart0 = 21416
; create_ic, "icsL013.2N128-Glass032-Stroemgren", "minihalo-r12e-3n03e3-Ms025-glass", npart0, setup = 'minihalo3', /ICs;, /debug

; npart0 = 167
; create_ic, "icsL013.2N128-Glass032-Stroemgren", "minihalo-r03e-3n03e3-Ms050-glass", npart0, setup = 'minihalo1', /ICs;, /debug
; npart0 = 1338
; create_ic, "icsL013.2N128-Glass032-Stroemgren", "minihalo-r06e-3n03e3-Ms050-glass", npart0, setup = 'minihalo2', /ICs;, /debug
; npart0 = 10708
; create_ic, "icsL013.2N128-Glass032-Stroemgren", "minihalo-r12e-3n03e3-Ms050-glass", npart0, setup = 'minihalo3', /ICs;, /debug

; npart0 = 84
; create_ic, "icsL013.2N128-Glass032-Stroemgren", "minihalo-r03e-3n03e3-Ms100-glass", npart0, setup = 'minihalo1', /ICs;, /debug
; npart0 = 669
; create_ic, "icsL013.2N128-Glass032-Stroemgren", "minihalo-r06e-3n03e3-Ms100-glass", npart0, setup = 'minihalo2', /ICs;, /debug
; npart0 = 5354
; create_ic, "icsL013.2N128-Glass032-Stroemgren", "minihalo-r12e-3n03e3-Ms100-glass", npart0, setup = 'minihalo3', /ICs;, /debug

; npart0 = 535
; create_ic, "icsL013.2N128-Glass032-Stroemgren", "minihalo-r12e-3n03e3-Ms500-glass", npart0, setup = 'minihalo3', /ICs;, /debug
...
create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-N032-glass", milanres, setup = 'test6', /ICs;, /debug;, /coremc
create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-N064-glass", 8. * milanres, setup = 'test6', /ICs;, /debug;, /coremc
create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-N048-glass",  3.4 * milanres, setup = 'test6', /ICs ;, /debug;, /coremc
create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-N096-glass",  27.0 * milanres, setup = 'test6', /ICs ;, /debug;, /coremc
create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-N128-glass", 64. * milanres, setup = 'test6', /ICs;, /debug;, /coremc

; stop
;create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-milanres-glass", milanres, setup = 'test6', /ICs;, /debug;, /coremc
;create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-milanresx8-glass", 8 * milanres, setup = 'test6', /ICs;, /debug;, /coremc
;create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-milanresx64-glass", 64 * milanres, setup = 'test6', /ICs;, /debug;, /coremc


; create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-milanres-hybrid", milanres, setup = 'test6', /ICs, /coremc
; create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-milanresx8-hybrid", 8 * milanres, setup = 'test6', /ICs, /coremc
; create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-milanresx64-hybrid", 64 * milanres, setup = 'test6', /ICs, /coremc

; stop

; create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-milanres-mc", milanres, setup = 'test6', /ICs, /MC;, /debug;, /coremc
; create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-milanresx8-mc", 8 * milanres, setup = 'test6', /ICs, /MC;, /debug;, /coremc
; create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-milanresx64-mc", 64 * milanres, setup = 'test6', /ICs, /MC;, /debug;, /coremc

; stop

; npart0_iliev = long(128.^3 / 0.8^3 * 4/3. * !Pi * 0.0915^3)

; create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-nilievx00.125-glass", long(0.125 * npart0_iliev), setup = 'test6', /ICs;, /debug
; create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-nilievx00.125-mc", long(0.125 * npart0_iliev), setup = 'test6', /ICs, /MC;, /debug

; create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-nilievx04.000-glass", 4 * npart0_iliev, setup = 'test6', /ICs; , /debug
; create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-nilievx04.000-mc", 4 * npart0_iliev, setup = 'test6', /ICs, /MC;, /debug

; create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-nilievx02.000-glass", 2 * npart0_iliev, setup = 'test6', /ICs;, /debug
; create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-nilievx02.000-mc", 2 * npart0_iliev, setup = 'test6', /ICs, /MC;, /debug

; create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-nilievx00.250-mc", long(0.25 * npart0_iliev), setup = 'test6', /ICs, /MC;, /debug
; create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-nilievx00.250-glass", long(0.25 * npart0_iliev), setup = 'test6', /ICs;, /debug

; create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-nilievx01.000-mc", npart0_iliev, setup = 'test6', /ICs, /MC;, /debug
; create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-nilievx01.000-glass",  npart0_iliev, setup = 'test6', /ICs;, /debug

; create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-nilievx00.500-mc", 0.5 * npart0_iliev, setup = 'test6', /ICs, /MC;, /debug
; create_ic, "icsL013.2N128-Glass032-Stroemgren", "test6-nilievx00.500-glass", 0.5 * npart0_iliev, setup = 'test6', /ICs;, /debug
