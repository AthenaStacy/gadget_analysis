...
int main(int argc, char **argv)
{
  ...
  sprintf(output_fname, "/work/utexas/ao/minerva/sphere_shift_040");
	  ...
	  for(n=0, pc_sph=pc; n<header1.npart[0];n++)
	    {
	      fread(&P[pc_sph].elec, sizeof(float), 1, fd);
              fwrite(&P[pc_sph].elec, sizeof(float), 1, outfile);
	      pc_sph++;
	    }
	  SKIP;
          WSKIP;
	  ...
	  for(n=0, pc_sph=pc; n<header1.npart[0];n++)
	    {
	      fread(&P[pc_sph].HI, sizeof(float), 1, fd);
              fwrite(&P[pc_sph].HI, sizeof(float), 1, outfile);
	      pc_sph++;
	    }
	  SKIP;
          WSKIP;
	  ...
	  for(n=0, pc_sph=pc; n<header1.npart[0];n++)
	    {
	      fread(&P[pc_sph].HeI, sizeof(float), 1, fd);
              fwrite(&P[pc_sph].HeI, sizeof(float), 1, outfile);
	      pc_sph++;
	    }
	  SKIP;
          WSKIP;
	  ...
	  for(n=0, pc_sph=pc; n<header1.npart[0];n++)
	    {
	      fread(&P[pc_sph].H2II, sizeof(float), 1, fd);
              fwrite(&P[pc_sph].H2II, sizeof(float), 1, outfile);
	      pc_sph++;
	    }
	  SKIP;
          WSKIP;
	  ...
	  for(n=0, pc_sph=pc; n<header1.npart[0];n++)
	    {
	      fread(&P[pc_sph].HM, sizeof(float), 1, fd);
              fwrite(&P[pc_sph].HM, sizeof(float), 1, outfile); 
	      pc_sph++;
	    }
	  SKIP;
	  WSKIP;
	  ...
	  for(n=0, pc_sph=pc; n<header1.npart[0];n++)
	    {
	      ...
	      fwrite(&P[pc_sph].DI, sizeof(float), 1, outfile);
	      pc_sph++;
	    }
	  SKIP;
	  WSKIP;
	  ...
	  for(n=0, pc_sph=pc; n<header1.npart[0];n++)
	    {
	      ...
	      fwrite(&P[pc_sph].DM, sizeof(float), 1, outfile);
	      pc_sph++;
	    }
	  SKIP;
	  WSKIP;
	  ...
	  for(n=0, pc_sph=pc; n<header1.npart[0];n++)
	    {
	      ...
	      fwrite(&P[pc_sph].HDII, sizeof(float), 1, outfile);
	      pc_sph++;
	    }
	  SKIP;
	  WSKIP;
	  ...
	  for(n=0, pc_sph=pc; n<header1.npart[0];n++)
	    {
	      ...
	      fwrite(&P[pc_sph].FosHII, sizeof(float), 1, outfile);
	      pc_sph++;
	    }
	    SKIP;
	    WSKIP;
