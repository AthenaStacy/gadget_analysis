...
*/
  ...
  sprintf(output_fname, "/scratch/00863/minerva/bin_zoom10_new_ref_1000");
...
int write_snapshot(char *fname, int files, char *outname, double delx, double dely, double delz, double  boxsize)
{
  ...
  int Idnew, /*nnew=512*/ nnew=8;
  double *pos, massnew, hsmnew, x, y, z, dis, /*nnew_doub=512.0*/ nnew_doub=8.0;
  double randomx, randomy, randomz, nh, nhmax;
  //double dmax = 5.0;  //size of 'cut-out' square in pc
  double dmax = 2000.0;  //size of 'cut-out' square in pc
